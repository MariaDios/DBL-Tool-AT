...
DEFAULT_SCORES = {
    "Belgium — Woningpas": {
        ...
        "justifications":{"Energy Performance Data":"EPC fully integrated — insulation, heating, renewables auto-populated from Flemish EPC registry.","Technical Documentation":"Permits included via Flemish database — no building plans or technical specifications.","Renovation History":"Completed renovation works listed as core theme; inspections and certificates linked.","Material Passport":"Listed as future goal only — not implemented in current version.","Waste & CDW Support":"OVAM co-founding partner contributing soil data only — no CDW tracking.","Urban Mining Potential":"Not mentioned in any source.","Legal Mandate":"Flemish regional instrument — voluntary, no national mandate.","Governance Clarity":"Co-created by 3 ministers and 5 Flemish agencies; VEKA as managing authority.","Privacy & Data Rights":"GDPR-compliant; owner controls time-limited access via sharing module.","BIM Integration":"No BIM or IFC integration documented.","Open API / Data Exchange":"Open service layer reusable by Flemish public entities via Magda platform.","Cross-system Alignment":"Multiple Flemish databases linked via Magda — no EU data model alignment.","Owner Access":"Free, auto-populated, accessible via eID or itsme — Dutch only.","Professional Access":"Delegated access only, no professional dashboard — Dutch only.","Ease of Use":"Fully automated content generation — platform Dutch only.","Construction & Design Phase":"Permits listed as theme — no design documentation or new-build integration.","Operation & Renovation Phase":"Core purpose — renovation advice, energy tracking, subsidy links, 2050 guidance.","End-of-Life Phase":"Not documented in any source."},
    },
    "France — CIL": {
    ...
    "Netherlands — Madaster": {
        ...
        "justifications":{"Energy Performance Data":"Embodied carbon and LCA documented — no EPC or operational energy data.","Technical Documentation":"BIM (IFC) upload from Revit, Archicad, Autodesk as primary input.","Renovation History":"Material tracking across lifecycle — no dedicated renovation history log.","Material Passport":"Core feature — full component-level documentation with reuse potential and residual value.","Waste & CDW Support":"Circularity Insights module tracks reuse, recyclability and recovery — demolishers as user group.","Urban Mining Potential":"Residual value and asset valuation module — unique feature among all reviewed systems.","Legal Mandate":"Voluntary commercial platform — no legal mandate.","Governance Clarity":"Private company with Madaster Foundation oversight — no public authority.","Privacy & Data Rights":"GDPR compliance implied; user-controlled data access per project.","BIM Integration":"BIM upload is primary data input — IFC, Revit, Archicad, Autodesk all supported.","Open API / Data Exchange":"Open API connects to 100+ EPD databases — primary interoperability mechanism.","Cross-system Alignment":"EU Taxonomy, Level(s), ESG, CSRD, LEED, BREEAM compliance documented.","Owner Access":"Asset owners listed as user group — BIM expertise required, not for non-experts.","Professional Access":"Full dashboards for architects, engineers, contractors, demolishers and consultants.","Ease of Use":"Requires BIM or Excel input — designed for professionals not building owners.","Construction & Design Phase":"BIM upload from design phase — material registration from construction start.","Operation & Renovation Phase":"Material tracking continues through operation — circularity benchmarks updatable.","End-of-Life Phase":"Demolishers as explicit user group — residual value and deconstruction data documented."},
    },
    "EU — iBRoad": {
